...
import com.gi.mapdirection.directionhelpers.FetchURL;
import com.gi.mapdirection.directionhelpers.TaskLoadedCallback;
            ...
            private void myDailog() {
                ...
                submitBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        place1 = new MarkerOptions().position(new LatLng(lat, lan)).title("Location 1");
                        place2 = new MarkerOptions().position(new LatLng(lat, lan)).title("Location 2");
                        ...
                        if (zoom.equalsIgnoreCase("world"))
                            ...
                            zoomlevel = 20;
                        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(lat, lan), zoomlevel));
