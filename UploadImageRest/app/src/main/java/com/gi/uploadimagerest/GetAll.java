                ...
                if (response.isSuccessful()) {
                    ...
                    for (int j = 0; j < images.size(); j += 2) {
                        ...
                        if (images.get(j).getUrl() == null) {
                            img1.setBackgroundResource(R.drawable.ic_baseline_image_24);                            // If no image is available, set a default image
                        } else {
                        ...
                        try {
                            ...
                            if (images.get(j+1).getUrl() == null) {
                                img2.setBackgroundResource(R.drawable.ic_baseline_image_24);
                            } else {
