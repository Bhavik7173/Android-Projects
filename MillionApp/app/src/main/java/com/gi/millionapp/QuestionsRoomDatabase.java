...
public abstract class QuestionsRoomDatabase extends RoomDatabase {
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            wordDao.insert(new Questions("Which crop was significant to the early growth of the North American colonies in the 1600s?", "Tobacco", "Cotton", "Uranium", "Gold", "Tobacco"));
            wordDao.insert(new Questions("Which country gifted the 'Statue of Liberty' to USA in 1886?", "France", "Canada", "Brazil", "England", "France"));
            wordDao.insert(new Questions("Dead Sea is located between which two countries?", "Jordan And Sudan", "Jordan And Israel", "Turkey And UAE", "UAE And Egypt", "Jordan And Israel"));
            wordDao.insert(new Questions("Which country is known as the 'Land of Thanderbolts'?", "China", "Bhutan", "Mongolia", "Thailand", "Bhutan"));
            wordDao.insert(new Questions("Which plateau is known as the 'Roof of the world'?", "Andes", "Himalaya", "Karakoram", "Pamir", "Pamir"));
