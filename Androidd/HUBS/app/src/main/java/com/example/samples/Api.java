...
import com.example.samples.Frags.AllAchievementData;
import com.example.samples.Frags.AllAlumniData;
import com.example.samples.Frags.AllCompanyData;
import com.example.samples.Frags.AllEventData;
import com.example.samples.Frags.AllFacultyData;
import com.example.samples.Frags.AllJobData;
import com.example.samples.Frags.AllSkillData;
import com.example.samples.Frags.HomeResponse;
import com.example.samples.Frags.ProProfileDetails;
import com.example.samples.Frags.StudentInfo;
import com.example.samples.NotificationSender.MyResponse;
import com.example.samples.NotificationSender.NotificationSender;
...
public interface Api
{
    ...
    Call <ProProfileResponse> proprofile_u(@Field("Qua") String Qua, @Field("YOP") String YOP, @Field("Exp") String Exp, @Field("Link") String Link, @Field("email") String Email);

    @FormUrlEncoded
    @POST("studentprofile_u.php")
    Call <ProProfileResponse> studentprofile_u(@Field("C") String C, @Field("Div") String Div, @Field("Mentor") String Mentor, @Field("email") String Email);

    @FormUrlEncoded
    @POST("perprofile_u.php")
    Call <ProfileResponse> perprofile_u(@Field("name") String name, @Field("dob") String dob, @Field("phone") String phone, @Field("address") String address, @Field("image") String image, @Field("email") String Email);

    @FormUrlEncoded
    @POST("achievement_ud.php")
    Call <AchievementResponse> achievement_ud(@Field("ach") String ach, @Field("rank") String rank, @Field("year") String year, @Field("image") String image, @Field("email") String Email, @Field("tbl") String tbl);
    ...
    @FormUrlEncoded
    @POST("skill.php")
    Call <SkillResponse> skill(@Field("skill") String Skill, @Field("email") String Email);

    @FormUrlEncoded
    @POST("skill_ud.php")
    Call <SkillResponse> skill_ud(@Field("skill") String Skill, @Field("time") String Time, @Field("email") String Email, @Field("tbl") String tbl);
    ...
    Call <JobApplicationResponse> jobapplication(@Field("job_application") String job_application, @Field("email") String Email, @Field("tbl") String tbl);
