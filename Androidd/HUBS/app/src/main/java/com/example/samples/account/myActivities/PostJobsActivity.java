...
import com.example.samples.PostJobsResponse;
        ...
        PJ.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cnt==0) {
                    ...
                    call = api.postjobs1(JT.getText().toString(),JRE.getText().toString(),JD.getText().toString(),JSD.getText().toString(),JED.getText().toString(),JS.getText().toString(),JL.getText().toString(),pdfupload,pdfile_request,imageupload,companylogo_request,pdfname,imagename,email);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==GALLERY_REQUEST && resultCode==RESULT_OK)
        {
            try
            {
                ...
                CLPath=getFilePathFromURI(PostJobsActivity.this,uri);
            }
            catch (Exception ex)
            {
           ...
           pdfpath = getFilePathFromURI(PostJobsActivity.this,uri);
