...
import com.example.samples.Frags.AlumniDetails;
...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Glide.with(holder.imageView.getContext()).load(context.getString(R.string.IP)+alumniNames.get(position).getPer_Image()).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).apply(RequestOptions.circleCropTransform()).into(holder.imageView);
    }
