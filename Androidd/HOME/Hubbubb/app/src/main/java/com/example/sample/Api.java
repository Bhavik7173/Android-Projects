...
/*
    ...
    @FormUrlEncoded
    @POST("signup1.php")
    Call <ProfileResponse> signup1(@Field("u_name") String name,@Field("u_dob") String dob,@Field("u_gen") String gen,@Field("u_cn1") String cn1,@Field("u_cn2") String cn2,@Field("u_status") String status,@Part MultipartBody.Part file,@Field("u_address") String addr,@Field("u_hobby") String hobby,@Field("u_interest") String intrest,@Field("u_email") String email,@Field("u_password") String password);
*/
    @Multipart
    @FormUrlEncoded
    @POST("signup1.php")
