...
public class RCAdapter_A extends RecyclerView.Adapter<RCAdapter_A.MyHolder> {

    ArrayList<AllAlumniData> arrayList;
    List<String> Name;
    List<String> Age;
    List<String> Gender;
    List<String> Contact;
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.rvcl_alumni,null);
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, int position) {
       ...
       // Log.d("Whyred1",ImagePath);
        ...
        Glide.with(holder.Image.getContext()).load(context.getString(R.string.IP)+Image.get(position)).error(R.drawable.ic_person_black_24dp).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).apply(RequestOptions.circleCropTransform()).into(holder.Image);
        Log.d("Whyred1", R.string.IP+Image.get(position));
    ...
    public RCAdapter_A(List<String> Name, List<String> Age, List<String> Gender, List<String> Contact, List<String> Image, List<String> Status, List<String> Email, List<String> Qualification, List<String> YOP, List<String> Experience, List<String> Link, Context context) {
