...
public class FragmentProfile extends Fragment {
    ...
    void set(String PE, String PN, String PI, String PC, String PA, String DOB)
    {
        ...
        Glide.with(imageView.getContext()).load(getString(R.string.IP)+PI).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).apply(RequestOptions.circleCropTransform()).listener(new RequestListener<Drawable>() {
            @Override
