...
import com.example.samples.LikeResponse;
...
public class RCAdapter_E extends RecyclerView.Adapter<RCAdapter_E.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, final int position) {
        ...
        Glide.with(holder.Img.getContext()).load(context.getString(R.string.IP)+EI.get(position)).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).into(holder.Img);
