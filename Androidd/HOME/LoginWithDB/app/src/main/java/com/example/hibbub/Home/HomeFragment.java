...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ar = new ArrayList<>();
            ...
            retro = MyRetrofit.getRetrofit("http://192.168.29.85/notification");
        api_inter = retro.create(Api_inter.class);
        Call<List<HomeResponse>> call = api_inter.getHomeData();
