...
public class FragmentProfile extends Fragment {
    ...
    void send()
    {
        ...
        api=instance.create(Api.class);
        call=api.perprofile_u(mainName.getText().toString().trim(), mainDOB.getText().toString().trim(), mainPhone.getText().toString().trim(), mainAddress.getText().toString().trim(), fileupload, email);
