...
public class FragmentPostJobs extends Fragment {
        ...
        PJ.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cnt==0) {
                    ...
                    call = api.postjobs(fileupload,JT.getText().toString(),JRE.getText().toString(),JD.getText().toString(),JSD.getText().toString(),JED.getText().toString(),JS.getText().toString(),JL.getText().toString(),id);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == GALLERY_REQUEST && resultCode == RESULT_OK) {
            ...
            //Toast.makeText(FragmentPostJobs.this, "image not selected...", Toast.LENGTH_LONG).show();
        }
    }
