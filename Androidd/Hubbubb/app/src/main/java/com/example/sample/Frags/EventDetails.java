...
public class EventDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // progressBar=findViewById(R.id.progressbar);
        ...
        Glide.with(Img.getContext()).load(getString(R.string.IP1)+EI).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).apply(RequestOptions.circleCropTransform()).listener(new RequestListener<Drawable>() {
            @Override
