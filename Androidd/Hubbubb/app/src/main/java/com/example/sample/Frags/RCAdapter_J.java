...
public class RCAdapter_J extends RecyclerView.Adapter<RCAdapter_J.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, final int position) {
        ...
        Glide.with(holder.Img.getContext()).load(context.getString(R.string.IP1)+JI.get(position)).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).into(holder.Img);
