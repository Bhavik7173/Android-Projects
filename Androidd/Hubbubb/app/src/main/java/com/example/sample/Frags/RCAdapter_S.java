...
public class RCAdapter_S extends RecyclerView.Adapter<RCAdapter_S.MyHolder> {
    ...
    public RCAdapter_S(ArrayList<AllSkillData> arrayList, ArrayList<String> skill, ArrayList<String> time, Context context) {
    ...
    public RCAdapter_S(ArrayList<AllSkillData> ar) {
