...
public class PersonalProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<Userinfo>() {
            ...
            public void onResponse(Call<Userinfo> call, Response<Userinfo> response) {
                ...
                Log.d("perpro",userinfo.toString());
                set(userinfo.getPE(), userinfo.getPN(), userinfo.getPI1(), userinfo.getPC(),
    ...
    void set(String PE, String PN, String PI, String PC, String PA, String PDOB) {
        ...
        if(!PI.isEmpty() || PI!=null) {
            Glide.with(this).load(getString(R.string.IP1) + PI).error(R.drawable.ic_person_black_24dp).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).apply(RequestOptions.circleCropTransform()).listener(new RequestListener<Drawable>() {
                @Override
    ...
    void send() {
        ...
        api = instance.create(Api.class);
        call = api.perprofile_u(Name.getText().toString().trim(), DOB.getText().toString().trim(), Phone.getText().toString().trim(), Address.getText().toString().trim(), fileupload, email);
