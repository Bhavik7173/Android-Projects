...
public class NewAdmissionAdapter extends RecyclerView.Adapter<NewAdmissionAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public NewAdmissionAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem = layoutInflater.inflate(R.layout.layout_admin_new_admission, parent, false);
        NewAdmissionAdapter.ViewHolder viewHolder = new NewAdmissionAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull NewAdmissionAdapter.ViewHolder holder, int position) {
