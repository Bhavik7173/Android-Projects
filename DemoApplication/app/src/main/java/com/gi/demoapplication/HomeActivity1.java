package com.gi.demoapplication;
...
import com.gi.demoapplication.databinding.ActivityHome1Binding;
...
public class HomeActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarHome1.toolbar.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.search_activity1, menu);
        return true;
    }
