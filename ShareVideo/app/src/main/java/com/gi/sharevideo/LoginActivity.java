...
public class LoginActivity extends AppCompatActivity {
    ...
    TextView sendOTP,confirmOTP,resendOTP,changeP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                call.enqueue(new Callback<OTP>() {
                    ...
                    public void onFailure(Call<OTP> call, Throwable t) {
                        Toast.makeText(LoginActivity.this,"Problem in sending new OTP", Toast.LENGTH_LONG).show();
        ...
        sendOTP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View dialogView = LayoutInflater.from(LoginActivity.this).inflate(R.layout.progressdialog, viewGroup, false);
        ...
        if (check.equals("false"))
        {
            ...
            call.enqueue(new Callback< OTP>() {
                ...
                public void onResponse(Call< OTP> call, Response< OTP> response)
                {
                    ...
                    final AlertDialog.Builder builder = new AlertDialog.Builder( LoginActivity.this);
                    ViewGroup viewGroup = (ViewGroup) view.findViewById(android.R.id.content);
                    View dialogView = LayoutInflater.from( LoginActivity.this).inflate(R.layout.confirmotp, viewGroup, false);
