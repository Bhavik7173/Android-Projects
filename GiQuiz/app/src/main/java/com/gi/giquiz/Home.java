...
import com.gi.giquiz.Registration.SignUp;
                        ...
                        Retro.getRetrofit(Home.this).create(RetroInterface.class).insertKey(task.getResult()).enqueue(new Callback<String>() {
                            ...
                            public void onResponse(Call<String> call, Response<String> response) {
                                try {
                                    ...
                                    ErrorLogs.insertLogs(Home.this, sharedPre.getString("userID", ""), e.toString());
                            ...
                            public void onFailure(Call<String> call, Throwable t) {
                                ErrorLogs.insertLogs(Home.this, sharedPre.getString("userID", ""), t.toString());
