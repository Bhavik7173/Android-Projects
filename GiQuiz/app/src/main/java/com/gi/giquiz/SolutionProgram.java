...
public class SolutionProgram extends AppCompatActivity {
            ...
            /*case R.id.download:
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //createPdf();
                        Toast.makeText(SolutionProgram.this,"Please Contact The Admin",Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                });
    ...
    public void createPdf() {
        ...
        String path = Environment.getExternalStorageDirectory().toString() + "/Download/ProgramingQuiz/";
        Log.d("gilog", path);
        ...
        try {
            ...
            path = path + "/" + title + "_" + programNo + ".pdf";
            file = new File(path);
            if (!file.exists())
                file.createNewFile();
        } catch (IOException e) {
