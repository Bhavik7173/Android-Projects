...
public class ForgotOTP extends AppCompatActivity {
        ...
        SafetyNet.getClient(this)
                ...
                .addOnCompleteListener(new OnCompleteListener<SafetyNetApi.HarmfulAppsResponse>() {
                    ...
                    public void onComplete(Task<SafetyNetApi.HarmfulAppsResponse> task) {
                        ...
                        Log.d("MY_APP_TAG", task.toString());
                        if (task.isSuccessful()) {
                            SafetyNetApi.HarmfulAppsResponse result = task.getResult();
                            long scanTimeMs = result.getLastScanTimeMs();
                            List<HarmfulAppsData> appList = result.getHarmfulAppsList();

                            Log.d("MY_APP_TAG_RESULT",result.toString());
                            Log.d("MY_APP_TAG_SCANTIMEMS",scanTimeMs+"");
                            Log.d("MY_APP_TAG_APPLIST", appList.toString());

                            if (appList.isEmpty()) {
                                Log.d("MY_APP_TAG", "There are no known " + "potentially harmful apps installed.");
                                Log.d("MY_APP_TAG", appList.toString());
                            } else {
                                Log.e("MY_APP_TAG","Potentially harmful apps are installed!");
                                for (HarmfulAppsData harmfulApp : appList) {
                                    Log.d("MY_APP_TAG", "Information about a harmful app:");
                                    Log.d("MY_APP_TAG",
                                            "  APK: " + harmfulApp.apkPackageName);
                                    Log.d("MY_APP_TAG",
                                            "  SHA-256: " + Arrays.toString(harmfulApp.apkSha256));
                ...
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        if (!task.isSuccessful()) {
                           ...
                           Toast.makeText(ForgotOTP.this, task.getResult(), Toast.LENGTH_SHORT).show();
                           Log.d("MY_APP_TAG getInstance",task.getResult());
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            Log.d("MY_VERIFICATION_CODE",e.getMessage());
        }
    };
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.d("MY_APP",task.getException().getMessage());
