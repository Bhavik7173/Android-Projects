...
public class FilePathCreator {
    ...
    public static MultipartBody.Part createMultiPart(String path, String spdfname,String pdfName)
    {
        File sfile = new File(path);// Create a file using the absolute path of the image
        RequestBody requestBody1 = RequestBody.create(MediaType.parse("*/*"), sfile);
        MultipartBody.Part spdfupload = MultipartBody.Part.createFormData(pdfName, sfile.getName(), requestBody1);
